...
class TestAssertUniqueUsernameEmail:
    ...
    def test_assert_unique_skip_id(self, db_session):
        ...
        _assert_unique_username_email(
            db_session, "testuser", "test@email.com", skip_id=user.id
        )
...
class TestCreateUser:
    ...
    def test_create_user_success(self, db_session):
        ...
        user_data = UserCreate(
            username="trainer1", email="trainer1@pokemon.com", password="password123"
        )
    ...
    def test_create_user_duplicate_username(self, db_session):
        ...
        user_data2 = UserCreate(
            username="trainer1", email="trainer2@pokemon.com", password="password456"
        )
    ...
    def test_create_user_duplicate_email(self, db_session):
        ...
        user_data1 = UserCreate(
            username="trainer1", email="shared@pokemon.com", password="password123"
        )
        create_user(user_data1, db_session)

        user_data2 = UserCreate(
            username="trainer2", email="shared@pokemon.com", password="password456"
        )
...
class TestCreateAdminUser:
    ...
    def test_create_admin_user_with_default_permissions(self, db_session):
        ...
        admin_data = AdminCreate(
            username="admin1", email="admin1@pokemon.com", password="adminpass"
        )
    ...
    def test_create_admin_user_duplicate(self, db_session):
        ...
        admin_data1 = AdminCreate(
            username="admin1", email="admin1@pokemon.com", password="pass"
        )
        create_admin_user(admin_data1, db_session)

        admin_data2 = AdminCreate(
            username="admin1", email="admin2@pokemon.com", password="pass"
        )
